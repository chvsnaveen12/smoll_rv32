...
void tick(Vcache_tb *top, VerilatedVcdC *tfp){
    top->clk_i = 0;
    top->eval();
...
u_int32_t read(Vcache_tb *top, VerilatedVcdC *tfp, u_int32_t addr){
    bool ready;
    top->req_valid_i = 1;
    top->req_addr_i = addr;
    top->req_wstrb_i = 0x0;
...
void write(Vcache_tb *top, VerilatedVcdC *tfp, u_int32_t addr, u_int32_t value){
    bool ready;
    top->req_valid_i = 1;
